...
function PostSection() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex fixed bottom-0 px-[50px] pt-[100px] min-w-[700px] min-h-[250px] mb-3 rounded-lg">
      <div className="bg-white w-full grid grid-cols-[auto,1fr,auto] gap-4">
        ...
        <div className="m-5">
          <button type="submit" className="p-3 px-5 bg-[#6c36eb] text-white rounded-lg text-[0.9rem]">SEND</button>
        </div>
      </div>
    </form>
  );
